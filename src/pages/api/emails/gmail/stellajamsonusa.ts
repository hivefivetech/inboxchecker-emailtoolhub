...
import { getGmailClientForStellajamsonusa } from "@/services/gmail/stellajamsonusa";

export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    try {
        const gmail = await getGmailClientForStellajamsonusa();
        ...
        console.error("Error fetching emails for dcruzjovita651:", error);
